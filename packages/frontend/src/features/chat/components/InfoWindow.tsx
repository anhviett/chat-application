        ...
        <div className="sticky top-0 z-10 bg-backgroundSidebar border-b border-gray-2 py-2.5">
          <div className="px-4 py-3 flex items-center justify-between h-full">
            ...
            <h5 className="text-black font-bold text-xl w-full flex items-center justify-between">
              Contact Info
              <Button
                className="hidden lg:flex text-gray-1 hover:bg-red-1 hover:text-white items-center justify-center h-6 w-6 rounded-full"
                onClick={() => dispatch(setInfoWindowOpen(false))}
              >
            ...
            <div>
              <div className="flex flex-col items-center text-center">
                ...
                <h6 className="text-white font-semibold">
                  ...
                  chatThread?.conversationId !== undefined ? (
              ...
              <div className="grid grid-cols-4 gap-4">
                <div className="text-center text-black rounded-md text-sm py-2 bg-white shadow-[0_1px_5px_1px_#f3f3f3]">
                  <a className="action-wrap" href="/react/template/chat">
                    <i className="fa-solid fa-phone text-sm text-purple-1 cursor-pointer"></i>
                    <p>Audio</p>
                  </a>
                </div>
                <div className="text-center text-black rounded-md text-sm py-2 bg-white shadow-[0_1px_5px_1px_#f3f3f3]">
                  <a className="action-wrap" href="/react/template/chat">
                    <i className="fa-solid fa-video text-sm text-purple-1 cursor-pointer"></i>
                    <p>Video</p>
                  </a>
                </div>
                <div className="text-center text-black rounded-md text-sm py-2 bg-white shadow-[0_1px_5px_1px_#f3f3f3]">
                  <a className="action-wrap" href="/react/template/chat">
                    <i className="fa-solid fa-paperclip text-sm text-purple-1 cursor-pointer"></i>
                    <p>File</p>
                  </a>
                </div>
                <div className="text-center text-black rounded-md text-sm py-2 bg-white shadow-[0_1px_5px_1px_#f3f3f3]">
                  <a className="action-wrap" href="/react/template/chat">
                    <i className="fa-solid fa-search text-sm text-purple-1 cursor-pointer"></i>
                    <p>Search</p>
                  </a>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-2">
                {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((i) => (
                  <img
                    ...
                    src={`https://picsum.photos/seed/chatmedia${i}/200/200`}
                    alt="Media"
                  />
                ))}
              </div>
