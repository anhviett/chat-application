                ...
                <div className="container mx-auto px-4 max-w-4xl">
                    <div className="bg-white rounded-lg shadow-lg border border-gray-200">
                        <ul className="divide-y divide-gray-200">
                            ...
                            <AccordionItem
                                icon={<i className="fa-solid fa-user text-blue-500 text-xl"></i>}
                            ...
                            <AccordionItem
                                icon={<i className="fa-solid fa-bell text-yellow-500 text-xl"></i>}
                                title={<span className="font-semibold text-gray-800">Notification Settings</span>}
                                isOpen={openItem === 2}
                            ...
                            <AccordionItem
                                icon={<i className="fa-solid fa-share-nodes text-green-500 text-xl"></i>}
                            ...
                            >
                                <div className="space-y-3">
                                    <p className="text-gray-600 mb-4">Customize how the app looks and feels</p>
