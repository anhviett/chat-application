      ...
      <div className="flex h-screen overflow-hidden">
        ...
        <div className="flex-1 ml-[72px] h-full overflow-hidden">
          <div className="relative grid grid-cols-12 h-full">
            ...
            */}
            <div className={`h-full bg-backgroundSidebar border-r border-gray-2 lg:min-w-0 min-w-72 ${isInfoWindowOpen ? 'hidden lg:block' : 'col-span-12 lg:col-span-3'}`}>
            ...
            */}
            <div className={`h-full lg:ml-0 ml-14 ${isInfoWindowOpen ? 'hidden lg:block lg:col-span-6' : 'col-span-9'}`}>
              {!chatThreadId ? (
                <ChatDefault className={`${isInfoWindowOpen ? '' : 'hidden lg:block'}`} />
              ) : (
                <Conversation
